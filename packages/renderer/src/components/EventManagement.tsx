...
export default function EventManagement() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900 text-gray-900 dark:text-gray-100 p-6 pt-10 drag-region">
      <div className="max-w-4xl mx-auto no-drag-region">
